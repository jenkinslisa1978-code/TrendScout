...
export default function UkProductResearchPage() {
  return (
    <SeoLandingTemplate
      headline="UK product research for smarter product validation"
      subtitle="Research product ideas for the UK market and decide whether they are actually worth testing. TrendScout combines demand signals, competition analysis, and UK-specific commercial checks in one workflow."
      intro={[
        ...
        'TrendScout is built specifically for UK sellers. Instead of just showing you trending products, we help you evaluate whether those products are commercially worth testing in the UK — factoring in costs, competition, and channel fit that generic tools ignore.',
        'Whether you sell on Shopify, Amazon.co.uk, or TikTok Shop UK, TrendScout gives you a clearer way to validate product ideas before you waste money on ads, inventory, or time.',
      ]}
      features={[
        { icon: Search, title: 'Multi-channel demand signals', desc: 'Spot products gaining traction across TikTok, Amazon, Shopify stores, and Google Trends — all in one dashboard.' },
        ...
        { icon: Zap, title: 'Decision support', desc: 'Use launch scores, score breakdowns, and supporting tools to decide which product ideas deserve a real test.' },
      ...
      steps={[
        ...
        { title: 'Decide what to test next', desc: 'Move forward with data, not guesswork. Prioritise stronger ideas and drop weaker ones earlier.' },
      ]}
      ukPoints={[
      ...
      ctaText="Start validating UK product ideas today"

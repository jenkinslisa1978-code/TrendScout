...
export default function ShopifyProductResearchUkPage() {
  return (
    <SeoLandingTemplate
      ...
      subtitle="Find and validate products for your UK Shopify store. TrendScout helps Shopify sellers discover trending products, check UK margins, and launch with more confidence."
      intro={[
        ...
        'TrendScout gives UK Shopify sellers the research tools they need: multi-channel trend detection, UK-specific margin analysis, competition data, and direct push-to-store integration. Find a product, validate it, and add it to your store in minutes.',
      ...
      features={[
        ...
        { icon: Search, title: 'Trend detection across channels', desc: 'Products identified from TikTok, Amazon, Google Trends, and competitor Shopify stores.' },
        ...
        { icon: Zap, title: 'AI ad creative ideas', desc: 'Get ad angles and audience targeting suggestions for your Shopify product pages.' },
      ]}
      steps={[
        ...
        { title: 'Test and scale', desc: 'Use AI ad suggestions to run smarter test campaigns.' },
      ]}
      ukPoints={[

...
# =====================
# SHOPIFY STORE ANALYZER & COMPETITOR TRACKER
# =====================
...
async def list_blog_posts(limit: int = 20):
    ...
    cached = _get_cached("blog_posts_list")
    if cached:
        return cached
    ...
    _set_cached("blog_posts_list", result)
    return result
...
Include sections for: Market Overview, Top Products Analysis, Seller Opportunities, Tips for Launching. Be specific and actionable."""
    ...
    slug = _slugify(article.get("title", f"trending-{category_slug}-products"))
    # Ensure unique slug
    ...
    # Clear cache
    _set_cached("blog_posts_list", None)
